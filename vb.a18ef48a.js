...
const L = {
  ...
  languageData: {
    ...
    commentTokens: { line: "'" },
    autocomplete: a.concat(f).concat(h).concat(s).concat(p).concat(v)
  }
};
export {
  L as vb
