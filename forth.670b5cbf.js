...
const L = {
  ...
  token: function(i, n) {
    ...
    if (E = i.match(/^(\S+)(\s+|$)/), E)
      return e(n.wordList, E[1]) !== void 0 ? "variable" : E[1] === "\\" ? (i.skipToEnd(), "comment") : e(n.coreWordList, E[1]) !== void 0 ? "builtin" : e(n.immediateWordList, E[1]) !== void 0 ? "keyword" : E[1] === "(" ? (i.eatWhile(function(R) {
        return R !== ")";
