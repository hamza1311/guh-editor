...
var l = c([
  ...
  "UInt64",
  "Void"
]), h = "+-/*%=|&<>~^?!", _ = ":;,.(){}[]", k = /^\-?0b[01][01_]*/, s = /^\-?0o[0-7][0-7_]*/, x = /^\-?0x[\dA-Fa-f][\dA-Fa-f_]*(?:(?:\.[\dA-Fa-f][\dA-Fa-f_]*)?[Pp]\-?\d[\d_]*)?/, y = /^\-?\d[\d_]*(?:\.\d[\d_]*)?(?:[Ee]\-?\d[\d_]*)?/, g = /^\$\d+|(`?)[_A-Za-z][_A-Za-z$0-9]*\1/, w = /^\.(?:\$\d+|(`?)[_A-Za-z][_A-Za-z$0-9]*\1)/, z = /^\#[A-Za-z]+/, b = /^@(?:\$\d+|(`?)[_A-Za-z][_A-Za-z$0-9]*\1)/;
function f(n, e, t) {
  ...
  if (n.match(b))
    return "attribute";
  if (n.match(k) || n.match(s) || n.match(x) || n.match(y))
    return "number";
  if (n.match(w))
    return "property";
  if (h.indexOf(i) > -1)
...
function a(n, e) {
  for (var t; n.match(/^[^/*]+/, !0), t = n.next(), !!t; )
    t === "/" && n.eat("*") ? e.tokenize.push(a) : t === "*" && n.eat("/") && e.tokenize.pop();
  return "comment";
}
function O(n, e, t) {
