...
function i(r, n) {
  return r.match(/^HTTP\/\d\.\d/) ? (n.cur = f, "keyword") : r.match(/^[A-Z]+/) && /[ \t]/.test(r.peek()) ? (n.cur = d, "keyword") : t(r, n);
}
function f(r, n) {
  var e = r.match(/^\d+/);
  if (!e)
...
function s(r, n) {
  return r.match(/^HTTP\/\d\.\d$/) ? (n.cur = u, "keyword") : t(r, n);
}
function u(r) {
...
const p = {
  token: function(r, n) {
    var e = n.cur;
    return e != u && e != c && r.eatSpace() ? null : e(r, n);
  },
