...
function d(e) {
  function r(n) {
    return n == e ? t() : e == ";" ? x() : t(r);
  }
  return r;
}
function b(e) {
  return e == "@" ? t(Z) : e == "var" ? t(l("vardef"), C, d(";"), f) : e == "keyword a" ? t(l("form"), v, b, f) : e == "keyword b" ? t(l("form"), b, f) : e == "{" ? t(l("}"), D, _, f, V) : e == ";" ? t() : e == "attribute" ? t(U) : e == "function" ? t(w) : e == "for" ? t(
    l("form"),
    d("("),
    l(")"),
    ae,
    ...
    f,
    f
  ) : e == "case" ? t(v, d(":")) : e == "default" ? t(d(":")) : e == "catch" ? t(
    l("form"),
    D,
    d("("),
    J,
    ...
    f,
    V
  ) : e == "import" ? t(q, d(";")) : e == "typedef" ? t(ne) : x(l("stat"), v, d(";"), f);
}
function v(e) {
  return $.hasOwnProperty(e) || e == "type" ? t(h) : e == "function" ? t(w) : e == "keyword c" ? t(O) : e == "(" ? t(l(")"), O, d(")"), f, h) : e == "operator" ? t(v) : e == "[" ? t(l("]"), m(O, "]"), f, h) : e == "{" ? t(l("}"), m(ue, "}"), f, h) : t();
}
function O(e) {
  return e.match(/[;\}\)\],]/) ? x() : x(v);
}
function h(e, r) {
...
function ae(e, r) {
  return e == "variable" ? (S(r), t(fe, v)) : x();
}
function fe(e, r) {
  if (r == "in")
    return t();
