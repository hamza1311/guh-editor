...
function d(e, i) {
  var n = e.peek();
  if (n == "'" || n == '"')
    return e.next(), s(e, i, h(n, "string"));
  if (n == "/") {
    if (e.next(), e.eat("*"))
      return s(e, i, D);
    if (e.eat("/"))
    ...
    if (n == "#")
      return e.next(), n = e.peek(), n == '"' ? (e.next(), s(e, i, h('"', "string"))) : n == "b" ? (e.next(), e.eatWhile(/[01]/), "number") : n == "x" ? (e.next(), e.eatWhile(/[\da-f]/i), "number") : n == "o" ? (e.next(), e.eatWhile(/[0-7]/), "number") : n == "#" ? (e.next(), "punctuation") : n == "[" || n == "(" ? (e.next(), "bracket") : e.match(/f|t|all-keys|include|key|next|rest/i) ? "atom" : (e.eatWhile(/[-a-zA-Z]/), "error");
    if (n == "~")
