...
function u(e, n) {
  ...
  return e.match(g) || e.match(z) ? "operator" : e.match(y) ? "punctuation" : e.match(O) ? "atom" : e.match(w) || n.prop && e.match(h) ? "property" : e.match(a) ? "keyword" : e.match(h) ? "variable" : (e.next(), t);
}
function k(e, n, i) {
  return function(f, r) {
    for (; !f.eol(); )
