...
var k = /[\^@!\|<>#~\.\*\-\+\\/,=]/, s = /(<-)|(:=)|(=<)|(>=)|(<=)|(<:)|(>:)|(=:)|(\\=)|(\\=:)|(!!)|(==)|(::)/, p = /(:::)|(\.\.\.)|(=<:)|(>=:)/, f = [
  ...
  "define",
  "do"
], l = ["end"], z = o(["true", "false", "nil", "unit"]), v = o([
  "andthen",
  "at",
  "attr",
  "declare",
...
function i(e, n) {
  ...
  var t = e.match(g);
  if (t)
    return n.doInCurrentLine ? n.doInCurrentLine = !1 : n.currentIndent++, t[0] == "proc" || t[0] == "fun" ? n.tokenize = x : t[0] == "class" ? n.tokenize = m : t[0] == "meth" && (n.tokenize = w), "keyword";
  if (e.match(d) || e.match(v))
    return "keyword";
  if (e.match(h))
