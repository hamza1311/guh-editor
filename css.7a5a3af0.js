function y(i) {
  i = { ...ae, ...i };
  var l = i.inline, m = i.tokenHooks, b = i.documentTypes || {}, G = i.mediaTypes || {}, J = i.mediaFeatures || {}, Q = i.mediaValueKeywords || {}, O = i.propertyKeywords || {}, N = i.nonStandardPropertyKeywords || {}, R = i.fontProperties || {}, ee = i.counterDescriptors || {}, F = i.colorKeywords || {}, V = i.valueKeywords || {}, g = i.allowNested, re = i.lineComment, oe = i.supportsAtComponent === !0, W = i.highlightNonStandardPropertyKeywords !== !1, w, n;
  function d(e, o) {
    return w = o, e;
  }
  function ie(e, o) {
    ...
    if (r === "-") {
      ...
      return /[,+>*\/]/.test(r) ? d(null, "select-op") : r == "." && e.match(/^-?[_a-z][_a-z0-9-]*/i) ? d("qualifier", "qualifier") : /[:;{}\[\]\(\)]/.test(r) ? d(null, r) : e.match(/^[\w-.]+(?=\()/) ? (/^(url(-prefix)?|domain|regexp)$/i.test(e.current()) && (o.tokenize = te), d("variableName.function", "variable")) : /[\w\\\-]/.test(r) ? (e.eatWhile(/[\w\\\-]/), d("property", "word")) : d(null, null);
  }
  function $(e) {
    return function(o, r) {
  ...
  function te(e, o) {
    return e.next(), e.match(/^\s*[\"\')]/, !1) ? o.tokenize = null : o.tokenize = $(")"), d(null, "(");
  }
  function D(e, o, r) {
  ...
  function L(e) {
    ...
    V.hasOwnProperty(o) ? n = "atom" : F.hasOwnProperty(o) ? n = "keyword" : n = "variable";
  }
  var a = {};
  return a.top = function(e, o, r) {
    ...
    if (e == "word") {
      ...
      return O.hasOwnProperty(t) ? (n = "property", "maybeprop") : N.hasOwnProperty(t) ? (n = W ? "string.special" : "property", "maybeprop") : g ? (n = o.match(/^\s*:(?:\s|$)/, !1) ? "property" : "tag", "block") : (n = "error", "maybeprop");
    } else
    ...
    if (e == "word") {
      var t = o.current().toLowerCase();
      t == "only" || t == "not" || t == "and" || t == "or" ? n = "keyword" : G.hasOwnProperty(t) ? n = "attribute" : J.hasOwnProperty(t) ? n = "property" : Q.hasOwnProperty(t) ? n = "keyword" : O.hasOwnProperty(t) ? n = "property" : N.hasOwnProperty(t) ? n = W ? "string.special" : "property" : V.hasOwnProperty(t) ? n = "atom" : F.hasOwnProperty(t) ? n = "keyword" : n = "error";
    }
    return r.context.type;
