import { C as E, E as R, s as G, t as m, b as N, L as A, i as Z, f as q, a as j, g as Y } from "./index.a0bf45a2.js";
import "lit";
...
const w = 1, I = 2, D = 3, M = 4, F = 5, B = 35, L = 36, J = 37, K = 11, H = 13;
function ee(e) {
...
function y(e, t) {
  ...
  return z = e, _ = a, X = O || null;
}
function Q(e, t) {
  this.name = e, this.parent = t, this.hash = t ? t.hash : 0;
  for (let a = 0; a < e.length; a++)
    this.hash += (this.hash << 4) + e.charCodeAt(a) + (e.charCodeAt(a) << 8);
}
const Oe = new E({
  start: null,
  shift(e, t, a, O) {
    return t == w ? new Q(y(O, 1) || "", e) : e;
  },
  reduce(e, t) {
  ...
  reuse(e, t, a, O) {
    let r = t.type.id;
    return r == w || r == H ? new Q(y(O, 1) || "", e) : e;
  },
  hash(e) {
    return e ? e.hash : 0;
  },
  ...
  if (e.next == 60) {
    if (e.advance(), e.next == 47) {
      ...
      if (t.context && a == t.context.name)
        return e.acceptToken(I);
      for (let O = t.context; O; O = O.parent)
        if (O.name == a)
          return e.acceptToken(D, -2);
      e.acceptToken(M);
    } else if (e.next != 33 && e.next != 63)
      return e.acceptToken(w);
  }
}, { contextual: !0 });
function S(e, t) {
  return new R((a) => {
    for (let O = 0, r = 0; ; r++) {
      ...
      if (a.next == t.charCodeAt(O)) {
        if (O++, O == t.length) {
          r > t.length && a.acceptToken(e, 1 - t.length);
          break;
        }
      } else
        O = a.next == t.charCodeAt(0) ? 1 : 0;
      a.advance();
    }
  });
}
const re = S(B, "-->"), ne = S(L, "?>"), oe = S(J, "]]>"), le = G({
  Text: m.content,
  ...
  tokenizers: [ae, re, ne, oe, 0, 1, 2, 3],
  topRules: { Document: [0, 6] },
  tokenPrec: 0
});
function h(e, t) {
  let a = t && t.getChild("TagName");
  return a ? e.sliceString(a.from, a.to) : "";
}
function C(e, t) {
  let a = t && t.firstChild;
  return !a || a.name != "OpenTag" ? "" : h(e, a);
}
function de(e, t, a) {
  let O = t && t.getChildren("Attribute").find((o) => o.from <= a && o.to >= a), r = O && O.getChild("AttributeName");
...
function ie(e, t) {
  var a;
  let O = Y(e).resolveInner(t, -1), r = null;
  ...
  if (r && (r.to > t || r.lastChild.type.isError)) {
    let o = r.parent;
    if (O.name == "TagName")
      return r.name == "CloseTag" || r.name == "MismatchedCloseTag" ? { type: "closeTag", from: O.from, context: o } : { type: "openTag", from: O.from, context: b(o) };
    ...
    let d = O == r || O.name == "Attribute" ? O.childBefore(t) : O;
    return (d == null ? void 0 : d.name) == "StartTag" ? { type: "openTag", from: t, context: b(o) } : (d == null ? void 0 : d.name) == "StartCloseTag" && d.to <= t ? { type: "closeTag", from: t, context: o } : (d == null ? void 0 : d.name) == "Is" ? { type: "attrValue", from: t, context: r } : d ? { type: "attrName", from: t, context: r } : null;
  } else if (O.name == "StartCloseTag")
    return { type: "closeTag", from: t, context: O.parent };
  for (; O.parent && O.to == t && !(!((a = O.lastChild) === null || a === void 0) && a.type.isError); )
    O = O.parent;
  return O.name == "Element" || O.name == "Text" || O.name == "Document" ? { type: "tag", from: t, context: O.name == "Element" ? O : b(O) } : null;
}
class me {
  constructor(t, a, O) {
    this.attrs = a, this.attrValues = O, this.children = [], this.name = t.name, this.completion = Object.assign(Object.assign({ type: "type" }, t.completion || {}), { label: this.name }), this.openCompletion = Object.assign(Object.assign({}, this.completion), { label: "<" + this.name }), this.closeCompletion = Object.assign(Object.assign({}, this.completion), { label: "</" + this.name + ">", boost: 2 }), this.closeNameCompletion = Object.assign(Object.assign({}, this.completion), { label: this.name + ">" }), this.text = t.textContent ? t.textContent.map((r) => ({ label: r, type: "text" })) : [];
  }
}
const W = /^[:\-\.\w\u00b7-\uffff]*$/;
function x(e) {
...
function $e(e, t) {
  let a = [], O = [], r = /* @__PURE__ */ Object.create(null);
  for (let n of t) {
    let $ = x(n);
    a.push($), n.global && O.push($), n.values && (r[n.name] = n.values.map(U));
  }
  let o = [], d = [], k = /* @__PURE__ */ Object.create(null);
  for (let n of e) {
    let $ = O, l = r;
    n.attributes && ($ = $.concat(n.attributes.map((c) => typeof c == "string" ? a.find((g) => g.label == c) || { label: c, type: "property" } : (c.values && (l == r && (l = Object.create(l)), l[c.name] = c.values.map(U)), x(c)))));
    let f = new me(n, $, l);
    k[f.name] = f, o.push(f), n.top && d.push(f);
  }
  d.length || (d = o);
  for (let n = 0; n < o.length; n++) {
    ...
    if ($.children)
      for (let f of $.children)
        k[f] && l.children.push(k[f]);
    else
      l.children = o;
  }
  return (n) => {
    var $;
    let { doc: l } = n.state, f = ie(n.state, n.pos);
    if (!f || f.type == "tag" && !n.explicit)
      return null;
    let { type: c, from: g, context: u } = f;
    if (c == "openTag") {
      let s = d, i = C(l, u);
      if (i) {
        let p = k[i];
        s = (p == null ? void 0 : p.children) || o;
      }
      return {
        from: g,
      ...
      return s ? {
        from: g,
        to: n.pos + (l.sliceString(n.pos, n.pos + 1) == ">" ? 1 : 0),
        options: [(($ = k[s]) === null || $ === void 0 ? void 0 : $.closeNameCompletion) || { label: s + ">", type: "type" }],
        validFor: W
      } : null;
    } else if (c == "attrName") {
      let s = k[h(l, u)];
      ...
      if (!s)
        return null;
      let i = k[h(l, u)], p = ((i == null ? void 0 : i.attrValues) || r)[s];
      ...
      let s = C(l, u), i = k[s], p = [], P = u && u.lastChild;
      s && (!P || P.name != "CloseTag" || h(l, P) != s) && p.push(i ? i.closeCompletion : { label: "</" + s + ">", type: "type", boost: 2 });
      let v = p.concat(((i == null ? void 0 : i.children) || (u ? o : d)).map((T) => T.openCompletion));
      if (u && (i == null ? void 0 : i.text.length)) {
        let T = u.firstChild;
        T.to > n.pos - 20 && !/\S/.test(n.state.sliceDoc(T.to, n.pos)) && (v = v.concat(i.text));
      }
      return {
        from: g,
        options: v,
...
const V = /* @__PURE__ */ A.define({
  parser: /* @__PURE__ */ se.configure({
    props: [
      ...
      /* @__PURE__ */ q.add({
        Element(e) {
          let t = e.firstChild, a = e.lastChild;
          return !t || t.name != "OpenTag" ? null : { from: t.to, to: a.name == "CloseTag" ? a.from : e.to };
        }
      })
    ]
  }),
...
function he(e = {}) {
  return new j(V, V.data.of({
    autocomplete: $e(e.elements || [], e.attributes || [])
  }));
}
export {
  $e as completeFromSchema,
  he as xml,
  V as xmlLanguage
};
